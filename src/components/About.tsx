...
const About = () => {
  ...
  return (
    <section id="a-propos" className="section-padding px-[5%] bg-primary/5 relative overflow-hidden">
      ...
      <div className="w-full md:mx-auto relative">
        <motion.div 
          ...
          viewport={{ once: true }}
          className="text-center flex items-center flex-col gap-3.5 w-full mb-9"
        >
