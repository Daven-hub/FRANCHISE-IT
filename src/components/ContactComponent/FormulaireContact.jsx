      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-12 md:mb-20">
          ...
          <div className="animate__animated animate__fadeInLeft animate__fast">
            ...
            <p className="text-base sm:text-lg md:text-xl text-center text-gray-600 mb-6 md:mb-8">
            ...
            <form className="space-y-4 md:space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                <div className="animate__animated animate__fadeInUp animate__fast">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 md:px-4 md:py-3 text-sm md:text-base rounded-lg border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none transition duration-200"
                  />
                </div>
              ...
              <div className="animate__animated animate__fadeInUp animate__fast animate__delay-4s">
                <button
                  type="submit"
                  className="w-full bg-primary text-white text-sm md:text-base font-medium py-2 md:py-3 px-4 md:px-6 rounded-lg transition duration-200 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:ring-offset-2 shadow-md hover:animate__animated hover:animate__pulse"
                >
                  Envoyer le message
                </button>
              </div>
          ...
          <div className="hidden lg:flex items-center justify-center animate__animated animate__fadeInRight animate__fast">
            <div className="relative w-full h-full rounded-xl overflow-hidden shadow-xl hover:animate__animated hover:animate__pulse">
              ...
              <div className="absolute bottom-6 md:bottom-10 left-6 md:left-10 right-6 md:right-10 text-white animate__animated animate__fadeInUp animate__slow animate__delay-1s">
                <h3 className="text-xl md:text-2xl lg:text-3xl font-bold mb-2 md:mb-3">Prêts à collaborer</h3>
        ...
        <div className="overflow-hidden">
          <div className="text-center py-4 md:py-5 animate__animated animate__fadeIn">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-transparent bg-clip-text bg-primary mb-3 md:mb-6">
              Notre Localisation
            </h2>
          ...
          <div className="flex flex-col lg:flex-row animate__animated animate__fadeInUp animate__fast">
            {/* Carte Google Maps */}
            <div className="w-full lg:w-2/3 h-64 sm:h-80 md:h-96 lg:h-auto animate__animated animate__fadeInLeft animate__fast">
              <iframe
            ...
            <div className="w-full lg:w-1/3 bg-gray-50 p-4 sm:p-6 md:p-8 flex flex-col justify-center animate__animated animate__fadeInRight animate__fast">
              <div className="mb-6 md:mb-8">
                <h3 className="text-xl sm:text-2xl font-bold text-primary mb-3 md:mb-4 animate__animated animate__fadeIn animate__delay-1s">
                  FRANCHISE IT
                </h3>
                <div className="space-y-2 md:space-y-3">
                  <p className="flex items-start text-xs sm:text-sm md:text-base text-gray-600 animate__animated animate__fadeIn animate__delay-1s">
                    <svg className="h-4 w-4 sm:h-5 sm:w-5 text-indigo-600 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
                     Carrefour Santa Barbara Douala<br />
                     Cameroun
                  </p>
                  <p className="flex items-center text-xs sm:text-sm md:text-base text-gray-600 animate__animated animate__fadeIn animate__delay-2s">
                    <svg className="h-4 w-4 sm:h-5 sm:w-5 text-indigo-600 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                    +237 695432799
                  </p>
                  <p className="flex items-center text-xs sm:text-sm md:text-base text-gray-600 animate__animated animate__fadeIn animate__delay-3s">
                    <svg className="h-4 w-4 sm:h-5 sm:w-5 text-indigo-600 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    info@franchise-it-tech.com
                  </p>
                </div>
              </div>

              <div className="animate__animated animate__fadeIn animate__delay-4s">
                <h4 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-2 md:mb-3">Heures d'ouverture</h4>
                <ul className="space-y-1 md:space-y-2 text-xs sm:text-sm md:text-base text-gray-600">
