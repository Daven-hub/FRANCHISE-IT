...
const FormationSection = () => {
    ...
    return (
        <section id="formation" className="section-padding px-[5%] md:px-[6%] bg-black relative overflow-hidden">
            ...
            <div className="w-full md:mx-auto relative">
                ...
                <div className="flex flex-col lg:flex-row-reverse items-center gap-14">
                    ...
                    >
                        <div className="relative">
                            ...
                            <motion.div
                                ...
                                className="absolute -bottom-6 -right-6 bg-primary/90 backdrop-blur-sm text-white px-4 py-3 rounded-xl shadow-xl z-10 border border-white/20"
                            >
                    ...
                    >
                        ...
                        <p className="text-[1rem] md:text-lg text-white/70 mb-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
                            {formations.map((formation, index) => (
                                ...
                                >
                                    ...
                                    <span className="text-white text-sm md:text-base">{formation}</span>
                                </motion.div>
                            ))}
                        </div>
