...
export default function ServicesCard({ service, isHovered, onHover, onLeave }) {
  return (
    <div 
  className="relative group w-full max-w-sm h-[450px]" // Hauteur fixe
...
>
  ...
  <div className="relative p-6 h-full bg-white rounded-2xl shadow-sm group-hover:shadow-md transition-all duration-300 overflow-hidden flex flex-col justify-between">
    ...
    <div>
      ...
      <div className="relative h-40 sm:h-44 mb-4 rounded-xl overflow-hidden group-hover:scale-[1.02] transition-transform duration-300">
        <img
          src={service.image}
          alt={service.title}
      ...
      <p className="text-gray-600 mb-4 line-clamp-2 text-sm sm:text-base">{service.description}</p>
    </div>
