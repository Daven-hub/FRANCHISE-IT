...
export const projectes = [
  {
    ...
    category: "Sociale",
    title: "Ounago",
    description: "Connecte les conducteurs avec des places libres aux passagers cherchant un trajet. Économisez de l'argent, rencontrez des gens et voyagez confortablement à travers le pays.",
    image: "/projet/ounago-mobile.jpeg",
    technologies: ["Flutter", "java", "MySql", "AWS"],
    link: "#",
  ...
  },
  {
    ...
    title: "Gecaf",
    description: "Connecte les conducteurs avec des places libres aux passagers cherchant un trajet. Économisez de l'argent, rencontrez des gens et voyagez confortablement à travers le pays.",
    image: "/projet/gecaf-mobile.jpeg",
    technologies: ["Flutter", "java", "MongoDB", "AWS"],
    link: "#",
    results: "Augmentation de 45% des transactions numériques",
    icons: [<Globe key="globe" />, <Lock key="lock" />, <Database key="db" />],
  },
  ...
  },
  {
    ...
    image: "/projet/upp-ppu.PNG",
    technologies: ["React", "php", "MySql", "AWS"],
  ...
  },
  {
    ...
    title: "Ounago",
    description: "Connecte les conducteurs avec des places libres aux passagers cherchant un trajet. Économisez de l'argent, rencontrez des gens et voyagez confortablement à travers le pays.",
    image: "/projet/ounago-web.PNG",
    technologies: ["Nextjs","AWS"],
    link: "https://www.ounago.com",
    results: "Augmentation de 45% des transactions numériques",
    icons: [<Globe key="globe" />, <Lock key="lock" />, <Database key="db" />],
  },
  {
